...
var local_api_1 = require("@aniketos-jsnote/local-api");
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    dir = path_1.default.join(path_1.default.join(process.cwd()), path_1.default.dirname(filename));
                ...
                case 2:
                    ...
                    if (error_1.code === 'EADDRINUSE') {
                        ...
                        console.log('Here is the problem', error_1.message);
                    }
                    process.exit(1);
                    return [3 /*break*/, 3];
